  ...
  return (
    <div style={{ fontFamily: "var(--font-inter), sans-serif", background: WHITE }}>
      ...
      <section style={{ position: "relative", width: "100%", minHeight: "clamp(380px, 64.6vw, 1117px)", overflow: "hidden", marginTop: -88 }}>
        <Image src="/images/contact-us/skill-college-contact-us-slider.png" alt="Contact Us" fill style={{ objectFit: "cover", objectPosition: "center" }} priority />
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-end", paddingBottom: 80, paddingLeft: 20, paddingRight: 20, textAlign: "center" }}>
          <h1 style={{ color: WHITE, fontWeight: 800, fontSize: "clamp(28px, 4vw, 56px)", marginBottom: 14, lineHeight: 1.1 }}>Contact Us</h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "clamp(13px, 1.2vw, 16px)", maxWidth: 520, lineHeight: 1.75 }}>Get in touch with us to learn more about our programs or discuss partnership opportunities.</p>
        </div>
      </section>
      ...
      <section style={{ background: WHITE, padding: "80px 20px", boxSizing: "border-box" }} className="md:px-[120px]">
        <div style={{ maxWidth: 1728, margin: "0 auto" }}>
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 60, alignItems: "flex-start" }}>
            ...
            <div>
              <h2 style={{ color: NAVY, fontWeight: 800, fontSize: "clamp(18px, 2vw, 24px)", marginBottom: 6 }}>Contact Information</h2>
              <p style={{ color: "#666", fontSize: 13, lineHeight: 1.75, marginBottom: 36 }}>We are here to answer your questions and discuss how we can work together to create impact.</p>
                ...
                {[
                  {
                    ...
                    lines: [contact?.addresses?.[0]?.address || "No 12 Aisha Plaza, Off Maishindam Cambua Road, Maiduguri, Borno State, Nigeria"],
                  },
                  {
                    icon: (
                    ...
                    label: "Phone Numbers",
                    lines: contact?.phones?.length ? contact.phones : ["+234 703 074 9599"],
                  },
                  {
                    icon: (
                    ...
                    label: "Email Address",
                    lines: [contact?.email || "skillcollegealtd@gmail.com"],
                  },
                  {
                    icon: (
                  ...
                  <div key={i} style={{ display: "flex", gap: 16, alignItems: "flex-start", paddingBottom: 24, marginBottom: 24, borderBottom: i < 3 ? "1px solid rgba(1,36,74,0.08)" : "none" }}>
      ...
      <section style={{ background: WHITE, padding: "0 20px 80px", boxSizing: "border-box" }} className="md:px-[120px]">
        <div style={{ maxWidth: 1728, margin: "0 auto" }}>
          <h3 style={{ color: NAVY, fontWeight: 700, fontSize: 16, marginBottom: 16 }}>Office Address</h3>
          <div style={{ background: ORANGE, borderRadius: 16, height: 280, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ color: WHITE, fontSize: 14, fontWeight: 600 }}>Google map</span>
          </div>
        </div>
      </section>
